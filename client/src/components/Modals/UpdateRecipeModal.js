...
const UpdateRecipeModal = ({
  ...
  const [formError, setFormError] = useState(
    recipe.category === "" || recipe.description === "" || recipe.name === ""
  );
      ...
      >
        ...
        <Modal.Actions>
          <Button
            ...
            disabled={isInProgressUpdateBool}
          >
            Zrušiť
          </Button>
          <Button
            type="button"
            color="blue"
            onClick={handleUpdateRecipe.bind(handleUpdateRecipe, false)}
            disabled={isInProgressUpdateBool}
          >
            Uložiť
          </Button>
